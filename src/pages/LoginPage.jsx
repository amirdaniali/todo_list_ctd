    ...
    return (
        <>
            <div style={componentStyle.container}>
                ...
                <form onSubmit={handleSubmit}>
                    <div style={componentStyle.formGroup}>
                        <label htmlFor="email" style={componentStyle.label}>
                            Email
                        </label>
                        <input
                            id="email"
                    ...
                    <div style={componentStyle.formGroup}>
                        <label htmlFor="password" style={componentStyle.label}>
                            Password
                        </label>
                        <input
                            id="password"
            ...
            <p style={{textAlign: 'center', color: '#000', fontSize: '1rem'}}>
                If you dont have an account/pass, Try the demo account with
                <br/>
                Email: <code style={{color: '#007bff'}}>demo@amirdaniali.com</code>
                <br/>
                Password: <code style={{color: '#007bff'}}>demo</code>
            </p>
        </>
    );
}
